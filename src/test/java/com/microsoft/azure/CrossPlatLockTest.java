...
public class CrossPlatLockTest {
    ...
    private String tester_filename;
    ...
    public void tenThreadsWritingToFile() throws IOException {
        ...
        Assert.assertEquals(popped, 10, "10 processes didn't write");
    ...
    public void tenProcessesWritingToFile() throws IOException, InterruptedException {
        ...
        Process process1 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(1), lockfile, tester_filename}).start();
        Process process2 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(2), lockfile, tester_filename}).start();
        Process process3 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(3), lockfile, tester_filename}).start();
        Process process4 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(4), lockfile, tester_filename}).start();
        Process process5 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(5), lockfile, tester_filename}).start();
        Process process6 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(6), lockfile, tester_filename}).start();
        Process process7 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(7), lockfile, tester_filename}).start();
        Process process8 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(8), lockfile, tester_filename}).start();
        Process process9 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(9), lockfile, tester_filename}).start();
        Process process10 = new ProcessBuilder(new String[]{"java", "-cp", FOLDER, "com.microsoft.azure.FileWriter", Integer.toString(10), lockfile, tester_filename}).start();
